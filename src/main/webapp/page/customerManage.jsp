...
<script type="text/javascript">
	...
	function openCustomerModifyDialog(){
		...
		$('#fm').form('load',row);
		url="${pageContext.request.contextPath}/customer/update.do?id="+row.id;
	}
	...
	function openCustomerOrder(){
		...
		window.parent.openTab('客户历史订单查询','orderManage.jsp?cusId='+selectedRows[0].id,'icon-jwjl');
	}
	...
	function resetValue(){
		...
		$("#level").cos_createTimetombobox("setValue","");
	 	...
	 	<form id="fm" method="post">
	 		<table cellspacing="8px">
	 			<tr>
	 				...
	 				<td>地区：</td>
	 				<td>
	 					<select class="easyui-combobox" id="area" name="area" style="width: 154px;" editable="false" panelHeight="auto">
	 			...
	 			<tr>
	 				<td>客户经理：</td>
	 				<td>
	 					<input class="easyui-combobox" id="cusManager" name="cusManager" data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${pageContext.request.contextPath}/comboList.do'"/>&nbsp;<font color="red">*</font>
	 				</td>
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td>客户等级：</td>
	 				<td>
	 					<input class="easyui-combobox" id="level" name="level" data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${pageContext.request.contextPath}/findDataDic.do?dataDicName=客户等级'"/>&nbsp;<font color="red">*</font>
	 				</td>
	 			</tr>
	 			<tr>
	 				<td>客户满意度：</td>
