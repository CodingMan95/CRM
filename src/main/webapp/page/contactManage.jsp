	...
	var url;
	 ...
	 $(function(){
		 ...
		 $('#dg').edatagrid({
            ...
            saveUrl: '${pageContext.request.contextPath}/contact/save.do?cusId=${param.cusId}',
            updateUrl: '${pageContext.request.contextPath}/contact/update.do',
...
<table id="dg" title="交往记录信息管理" style="width:800px;height:250px"
    ...
    <thead>
        <tr>
            ...
            <th field="cTime" width="100" editor="{type:'datebox',options:{required:true}}">交往时间</th>
            <th field="address" width="200" editor="{type:'validatebox',options:{required:true}}">交往地点</th>
