...
<script type="text/javascript">
	...
	function openUserModifyDialog(){
		...
		$('#fm').form('load',row);
		url="${pageContext.request.contextPath}/user/update.do?id="+row.id;
	}
	 	...
	 	<form id="fm" method="post">
	 		<table cellspacing="8px">
	 			...
	 			<tr>
	 				...
	 				<td>用户角色：</td>
	 				<td>
	 					<select class="easyui-combobox" id="roleName" name="roleName"  class="easyui-validatebox" required="true" style="width: 154px;" editable="false" panelHeight="auto">
