	...
	var url;
	 ...
	 $(function(){
		 ...
		 $('#dg').edatagrid({
            ...
            updateUrl: '${pageContext.request.contextPath}/linkMan/update.do',
...
<table id="dg" title="联系人信息管理" style="width:700px;height:250px"
    ...
    <thead>
        <tr>
            ...
            <th field="zhiwei" width="100" editor="{type:'validatebox',options:{validType:'date'}}">职位</th>
...
<div id="toolbar">
    <a href="javascript:addRow()" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:$('#dg').edatagrid('addRow')">添加</a>
    <a href="javascript:destroyRow()" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:$('#dg').edatagrid('destroyRow')">删除</a>
    <a href="javascript:saveRow()" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:$('#dg').edatagrid('saveRow');$('#dg').edatagrid('reload')">保存</a>
